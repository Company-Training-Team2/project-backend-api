...
{
    /// <inheritdoc />
    public partial class AuthUserSchema_v1 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "c3d4e5f6-a7b8-9012-cdef-123456789012", "Customer", "CUSTOMER" },
                    { 2, "d4e5f6a7-b8c9-0123-defa-123456789013", "Vendor", "VENDOR" },
                    { 3, "e5f6a7b8-c9d0-1234-efab-123456789014", "Admin", "ADMIN" }
                });

            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "ConcurrencyStamp", "Email", "EmailConfirmed", "EmailVerificationExpiry", "EmailVerificationToken", "IsActive", "IsEmailVerified", "LockoutEnabled", "LockoutEnd", "MfaSecret", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "RefreshToken", "RefreshTokenExpiry", "Role", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[] { 1, 0, "b2c3d4e5-f6a7-8901-bcde-f12345678901", "admin@eventhub.com", true, null, null, true, true, false, null, null, "ADMIN@EVENTHUB.COM", "ADMIN@EVENTHUB.COM", "AQAAAAIAAYagAAAAENK2VmHrnZ1dUFun4XUYZeOAuudubcXf1yWxGeF1yNqnn7iTJ0KEjLuobq5vS2nO3A==", null, false, null, null, 3, "a1b2c3d4-e5f6-7890-abcd-ef1234567890", false, "admin@eventhub.com" });
